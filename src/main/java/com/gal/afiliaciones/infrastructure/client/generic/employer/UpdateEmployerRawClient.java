...
/**
 * Update Employer Raw Client with automatic telemetry.
...
@Slf4j
public class UpdateEmployerRawClient {
    private final BusTokenService busTokenService;
    private final AffiliationProperties properties;

    public Mono<String> updateRaw(EmployerRequest request) {
        String url = properties.getBusUrlEmployer();
        log.info("Calling update employer endpoint (raw): {}", url);
