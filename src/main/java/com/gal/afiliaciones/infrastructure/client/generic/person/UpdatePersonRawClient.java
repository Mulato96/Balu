...
/**
 * Update Person Raw Client with automatic telemetry.
...
@Slf4j
public class UpdatePersonRawClient {
    private final BusTokenService busTokenService;
    private final AffiliationProperties properties;

    public Mono<String> updateRaw(PersonRequest request) {
        String url = properties.getBusUrlPerson();
        log.info("Calling update person endpoint (raw): {}", url);
