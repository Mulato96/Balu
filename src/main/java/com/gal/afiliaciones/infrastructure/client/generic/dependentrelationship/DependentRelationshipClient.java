...
public class DependentRelationshipClient {
    ...
    public Object insert(DependentRelationshipRequest request) {
        try {
            ...
            positivaLogService.saveFromResponse("DependentRelationshipClient", "insert", request.getIdTipoDoc(), request.getIdPersona(), null, "Trabajador Dependiente", null, null, response);
            return response;
        } catch (Exception ex) {
            ...
            positivaLogService.saveError("DependentRelationshipClient", "insert", request.getIdTipoDoc(), request.getIdPersona(), null, "Trabajador Dependiente", null, null, code, message);
            throw ex;
        }
    }
