...
/**
 * Update Work Center Client with automatic telemetry.
...
@Slf4j
public class UpdateWorkCenterClient {
    private final BusTokenService busTokenService;
    private final AffiliationProperties properties;

    public Object update(UpdateWorkCenterRequest request) {
        String url = properties.getWorkCenterUpdateUrl();
        log.info("Calling update work center endpoint: {}", url);
        log.debug("Sending work center update request payload: {}", safe(request));
