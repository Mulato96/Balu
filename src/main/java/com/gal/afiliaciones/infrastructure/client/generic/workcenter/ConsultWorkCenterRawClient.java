...
/**
 * Consult Work Center (Centro Trabajo) Raw Client with automatic telemetry.
...
@Slf4j
public class ConsultWorkCenterRawClient {
    ...
    public Mono<String> consultRaw(String idTipoDoc, String idEmpresa, Integer idSubEmpresa) {
        String url = properties.getWorkCenterConsultUrl()
                + "?idTipoDoc=" + idTipoDoc
                + "&idEmpresa=" + idEmpresa
                + "&idSubEmpresa=" + idSubEmpresa;
        
        log.info("Calling consult work center endpoint (raw): {}", url);
