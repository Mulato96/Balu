...
/**
 * Consult Employer Activation Raw Client with automatic telemetry.
...
@Slf4j
public class ConsultEmployerActivationRawClient {
    ...
    public Mono<String> consultRaw(String idTipoDoc, String idEmpresa, Integer idSubEmpresa) {
        ...
        log.info("Calling consult employer activation endpoint (raw): {}", url);
