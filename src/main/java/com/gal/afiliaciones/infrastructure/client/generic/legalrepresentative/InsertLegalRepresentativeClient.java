...
public class InsertLegalRepresentativeClient {
    ...
    public Object insertLegalRepresentative(LegalRepresentativeRequest request) {
        ...
        try {
            ...
            positivaLogService.saveFromResponse("InsertLegalRepresentativeClient", "insertLegalRepresentative", request.getIdTipoDoc(), request.getIdPersona(), buildFullName(request), null, null, null, response);
            return response;
        } catch (Exception ex) {
            ...
            positivaLogService.saveError("InsertLegalRepresentativeClient", "insertLegalRepresentative", request.getIdTipoDoc(), request.getIdPersona(), buildFullName(request), null, null, null, code, message);
            throw ex;
        }
    }

    private String buildFullName(LegalRepresentativeRequest request) {
