...
/**
 * Consult Work Center (Centro Trabajo) Client with automatic telemetry.
...
@Slf4j
public class ConsultWorkCenterClient {
    ...
    public Mono<List<Object>> consult(String idTipoDoc, String idEmpresa, Integer idSubEmpresa) {
        ...
        log.info("Calling consult work center endpoint: {}", url);
