...
@RestController
@AllArgsConstructor
@RequestMapping("/loadingbulk/official")
public class BulkLoadingDependentIndependentOfficialController {

    private final RecordLoadBulkService recordLoadBulkService;
    private final BulkLoadingDependentIndependentOfficialService bulkLoadingDependentIndependentService;

    @PostMapping(value = "/loading", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<ResponseServiceDTO> loadingOfficial(@RequestParam(name = "files") MultipartFile file,
    ...
    public ResponseEntity<ResponseServiceDTO> loadingOfficialWithNumber(@RequestParam(name = "files") MultipartFile file, 
                                                                       @RequestParam(name = "number") String number, 
                                                                       @RequestParam(name = "type") String type, 
                                                                       @RequestParam(name = "typeDocument") String typeDocument, 
                                                                       @RequestParam(name = "idOfficial") Long idOfficial){
