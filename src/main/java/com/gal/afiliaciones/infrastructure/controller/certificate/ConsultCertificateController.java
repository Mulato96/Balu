...
public class ConsultCertificateController {
    ...
    @PostMapping("/generatecertificatebalu")
    public ResponseEntity<List<ResponseCertificateBaluDTO>> generatecertificatebalu(@RequestBody RequestCertificateBaluDTO request) {
        return ResponseEntity.ok().body(consultCertificateService.generatecertificatebalu(request));
    }
