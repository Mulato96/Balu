...
public enum FieldsExcelLoadIndependent{
    ...
    EPS_CODE( "EPS TRABAJADOR", "O", "Validar información del campo EPS trabajador; puedes apoyarte en la tabla EPS del documento guía para diligenciar el archivo."),
    AFP_CODE( "AFP TRABAJADOR", "P", "Validar información del campo AFP trabajador; puedes apoyarte en la tabla AFP del documento guía para diligenciar el archivo."),
    ...
    CODE_CONTRACTING_ECONOMIC_ACTIVITY( "CÓDIGO DE ACTIVIDAD ECONÓMICA DEL CONTRATO", "W", "Validar información del campo Actividad económica; puedes apoyarte en la tabla Actividades Económicas del documento guía para diligenciar el archivo."),
