...
public enum FieldsExcelLoadDependent{
    ...
    EPS_CODE(                       "EPS TRABAJADOR",                   "M", "Validar información del campo Código EPS trabajador; puedes apoyarte en la tabla EPS del documento guía para diligenciar el archivo."),
    AFP_CODE(                       "AFP TRABAJADOR",                   "N", "Validar información del campo Código AFP trabajador; puedes apoyarte en la tabla AFP del documento guía para diligenciar el archivo."),
    ...
    SALARY(                         "SALARIO",                          "Q", "Validar información del campo Salario"),
    ...
    EMPLOYER_DOCUMENT_TYPE_CODE(    "CÓDIGO TIPO DOCUMENTO EMPLEADOR",  "U", "Validar información del campo Tipo documento identificación; puedes apoyarte en la tabla Tipos documento de identificación del documento guía para diligenciar el archivo."),
